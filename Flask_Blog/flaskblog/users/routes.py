...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash("Your accnt has been updated!", 'success')
...
#route decorators; routes are what we type in browsers to go to diff pages
...
def reset_token(token):
    ...
    if user is None:
        flash('That was an invalid token', 'warning')
